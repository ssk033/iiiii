...
db.tourist_places.insertMany([
  {
    ...
    transport: {
      ...
      by_road: "KSRTC buses from Bangalore, Mysore"
    },
    accommodation: "Resorts, Homestays, Hotels",
  ...
  },
  {
    ...
    place: "Hampi",
    address: { state: "Karnataka" },
    tourist_attractions: ["Vittala Temple", "Stone Chariot", "Lotus Mahal"],
    best_time: "November to February",
    transport: {
      nearest_airport: "Hubli Airport",
      nearest_railway: "Hospet Junction",
      by_road: "Direct buses from Bangalore"
    },
  ...
  },
  {
    ...
    transport: {
      ...
      nearest_railway: "Mysore Junction",
      by_road: "Buses from Bangalore every 15 mins"
    },
  ...
  },
  {
    ...
    accommodation: "Beach Resorts, Homestays",
  ...
  },
  {
    ...
    transport: {
      ...
      by_road: "Private taxis, KSRTC buses"
    },
    accommodation: "Hill Resorts, Hotels",
    food: "Kerala Sadya"
  },
  {
    id: 7,
  ...
  },
  {
    ...
    place: "Kumarakom",
    address: { state: "Kerala" },
    tourist_attractions: ["Bird Sanctuary", "Backwaters", "Vembanad Lake"],
    best_time: "October to February",
    transport: {
      nearest_airport: "Cochin Airport",
...
//-------------------------------------------------------------
// QUERY 1: Tourist places in Karnataka
//-------------------------------------------------------------
...
//-------------------------------------------------------------
// QUERY 2: Kerala tourist attractions (exclude accommodation & food)
//-------------------------------------------------------------
db.tourist_places.find(
  { "address.state": "Kerala" },
  {
